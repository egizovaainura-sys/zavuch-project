...
# --- 3. ФУНКЦИЯ ВХОДА ЧЕРЕЗ ГУГЛ ТАБЛИЦУ ---
...
if not st.session_state['logged_in']:
    ...
    with col1:
        st.info("Введите номер телефона, указанный при покупке доступа.")
        phone_input = st.text_input("Ваш номер:", placeholder="8775xxxxxxx")
